...
export function GlobalDesktopHeader(): JSX.Element {
  ...
  return (
    <header className='sticky top-0 z-50 hidden border-b border-gray-200 bg-white dark:border-[#2a1d10] dark:bg-[#1c1510] md:block'>
      <div className='mx-auto flex max-w-6xl items-center justify-between px-4 py-3'>
        ...
        <nav className='flex items-center gap-2 sm:gap-4'>
          {user && (
            <Link href='/ask'>
              <a className='flex items-center gap-1.5 text-xs font-medium text-gray-600 transition-colors hover:text-gray-900 dark:text-[#9E8B76] dark:hover:text-white sm:gap-2 sm:text-sm'>
          ...
          {user ? (
            <>
              <Button
                ...
                className='text-gray-600 hover:text-gray-900 dark:text-[#9E8B76] dark:hover:text-white'
              >
              ...
              <Button
                ...
                className='text-gray-600 hover:text-red-600 dark:text-[#9E8B76] dark:hover:text-red-400'
              >
