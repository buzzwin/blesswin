      ...
      <div className='mx-auto w-full max-w-6xl px-6'>
        <div className='mb-12 text-center'>
          <div className='mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30'>
            <Users className='h-8 w-8 text-[#8a6520] dark:text-[#9E8B76]' />
          </div>
        ...
        {loading ? (
          ...
          <div className='rounded-xl border-2 border-gray-200 bg-gray-50 p-12 text-center dark:border-[#2a1d10] dark:bg-[#231a10]'>
          ...
          <>
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
              {moments.map((moment) => (
                <div
                  key={moment.id}
                  className='group rounded-xl border-2 border-gray-200 bg-[#faf8f4] p-6 transition-all duration-300 hover:scale-105 hover:border-blue-500 hover:shadow-xl dark:border-[#2a1d10] dark:bg-[#1c1510]'
                >
                  ...
                  <p className='mb-4 line-clamp-3 text-gray-700 dark:text-[#C4B5A0]'>
                    {moment.text}
                  </p>
                  ...
                  <div className='mb-4 flex flex-wrap gap-2'>
                    {moment.tags?.slice(0, 3).map((tag, idx) => (
                      <span
                        key={idx}
                        className='rounded-full bg-[rgba(201,169,110,0.1)] px-3 py-1 text-xs font-medium text-[#7a5510] dark:bg-[rgba(201,169,110,0.08)]/30 dark:text-[#C4B5A0]'
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-4 text-sm text-gray-500 dark:text-[#9E8B76]'>
                      <span>
                    ...
                    <Link href={moment.id ? `/public/moment/${moment.id}` : '#'}>
                      <a className='text-sm font-medium text-[#8a6520] hover:underline dark:text-[#9E8B76]'>
                        View →
                      </a>
                    </Link>
                  </div>
            ...
            <div className='mt-8 text-center'>
              <Link href='/home'>
                <a className='inline-flex items-center gap-2 rounded-full border-2 border-[#C9A96E] px-6 py-3 text-base font-semibold text-[#8a6520] transition-colors hover:bg-[rgba(201,169,110,0.06)] dark:border-[rgba(201,169,110,0.45)] dark:text-[#9E8B76] dark:hover:bg-[rgba(201,169,110,0.08)]'>
