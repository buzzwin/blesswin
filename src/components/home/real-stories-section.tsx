      ...
      <div className='mx-auto w-full max-w-6xl px-6'>
        <div className='mb-12 text-center'>
          <div className='mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30'>
            <Sparkles className='h-8 w-8 text-[#C9A96E] dark:text-[#C9A96E]' />
          </div>
        ...
        <div className='mt-12 grid grid-cols-1 gap-6 md:grid-cols-2'>
          ...
          <div className='rounded-xl border-2 border-[rgba(201,169,110,0.3)] bg-gradient-to-br from-purple-50 to-pink-50 p-6 dark:border-[rgba(201,169,110,0.25)] dark:from-purple-900/20 dark:to-pink-900/20'>
            ...
            <Link href='/real-stories'>
              <a className='inline-flex items-center gap-2 text-sm font-semibold text-[#8a6520] hover:underline dark:text-[#C9A96E]'>
                Explore Stories
          ...
          <div className='rounded-xl border-2 border-[rgba(201,169,110,0.3)] bg-gradient-to-br from-blue-50 to-indigo-50 p-6 dark:border-[rgba(201,169,110,0.25)] dark:from-blue-900/20 dark:to-indigo-900/20'>
            <div className='mb-4 flex items-center gap-3'>
            ...
            <Link href='/real-stories'>
              <a className='inline-flex items-center gap-2 text-sm font-semibold text-[#7a5510] hover:underline dark:text-[#C4B5A0]'>
                See Reactions
                <ArrowRight className='h-4 w-4' />
              </a>
            </Link>
