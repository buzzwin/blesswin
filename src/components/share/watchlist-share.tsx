  ...
  return (
    <Modal open={isOpen} closeModal={onClose}>
      <div className='w-full max-w-md rounded-xl bg-[#faf8f4] p-6 dark:bg-[#1c1510]'>
        ...
        <div className='mb-6 rounded-lg bg-gray-50 p-4 dark:bg-[#1c1510]'>
          ...
          <div className='mt-2 flex items-center gap-2 text-sm text-gray-500 dark:text-[#9E8B76]'>
        ...
        <div className='space-y-4'>
          ...
          <div className='relative'>
            <input
              ...
              value={shareUrl}
              readOnly
              className='w-full rounded-lg border bg-gray-50 px-4 py-2 pr-20 text-sm dark:border-[#2a1d10] dark:bg-[#1c1510]'
            />
            <button
              onClick={() => void handleCopy()}
              className='absolute right-2 top-1/2 -translate-y-1/2 rounded-md bg-[rgba(201,169,110,0.06)]0 px-3 py-1 text-sm text-white hover:bg-[#C97D60]'
            >
              {copied ? 'Copied!' : 'Copy'}
            </button>
          </div>
