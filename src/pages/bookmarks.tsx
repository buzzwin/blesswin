...
export default function Bookmarks(): JSX.Element {
  ...
  const handleClear = async (): Promise<void> => {
    ...
    closeModal();
    toast.success('Successfully cleared all buzzes');
  };

  return (
    <MainContainer>
      <SEO title='Watchlist / Buzzwin' />
      <Modal
      ...
      >
        <ActionModal
          ...
          description='This can’t be undone and you’ll remove all Buzz you’ve added to your Bookmarks.'
      ...
      <MainHeader className='flex items-center justify-between'>
        <div className='-mb-1 flex flex-col'>
          <h2 className='-mt-1 text-xl font-bold'>Watch List</h2>
